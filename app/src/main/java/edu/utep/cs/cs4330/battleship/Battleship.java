...
public class Battleship{
    ...
    private boolean hasCoordinates = false; // 0 for false, 1 for true
    ...
    ArrayList<String> battleshipFinalCoordinates = new ArrayList<String>();

    public void placeShip(int boardsize) {
        int[] coorRandom = getRandomCoordinate(boardsize);
        coordinates[0] = coorRandom[0];
        coordinates[1] = coorRandom[1];
    }

    private int[] getRandomCoordinate(int boardsize) {
